 ...
 * Reweighting of all weights after I found out weights were in powers of 2 rather than
 * linear differences. Still testing, not necessarily better than V6, hence V6b
 *
 * @author Luca Weibel and Michiel Verburg
 */
public class DraughtBotV6b extends DraughtsPlayer {
...
//    final static int[] MIDDLEBACKRANK = {250, 250, 250, 250}; //value for middle in the backrank
    ...
    final static int[] DOUBLECORNER = {64, 64, 64, 64}; //play from the double corner (e.g. field 45 and 50)
    ...
    public DraughtBotV6b(int maxSearchDepth) {
        super("best.png");
